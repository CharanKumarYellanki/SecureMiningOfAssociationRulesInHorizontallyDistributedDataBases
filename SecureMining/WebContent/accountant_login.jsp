  ...
  <%@ include file="includes/DBconnect.jsp" %>
	  <%
		  ...
		  if(isValid) {	
		  ResultSet rs1;
				  rs1 = st.executeQuery("select * from users where user_name='" + lusername + "' and user_pass='" + lpassword + "' and user_type='ACCOUNTANT'");
		  if (rs1.next()) {
...
<body>
	...
	<div id="content">
		...
		<p id="pagehead">Accountant Login</p>
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <input id="password" name="lpassword"type="password" placeholder="Password">
        </div>
