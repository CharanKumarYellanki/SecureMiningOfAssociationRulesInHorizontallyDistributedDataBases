...
String sql="SELECT customer_id,customer_address,customer_mobile,customer_name,p.product_image_url,product_price,product_name,buyproduct_id FROM `buyproducts` b LEFT JOIN products p ON p.product_id=b.product_id WHERE product_type='purchase' AND b.order_report is NULL ";
