...
<body>
	...
	<!-- Content -->
	<div id="content">
			<p id="pagehead">Process Order Products</p>
...
%>  
    ...
    <tbody>
     ...
     ResultSet rs;
     rs=st.executeQuery("SELECT customer_id,customer_address,customer_mobile,customer_name,p.product_image_url,product_price,product_name,buyproduct_id FROM `buyproducts` b LEFT JOIN products p ON p.product_id=b.product_id WHERE product_type='order' AND b.order_report is not NULL");
     if(!rs.next()) { %>
